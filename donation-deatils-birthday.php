    ...
    <body>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<h2 class='mb-4'>User-Birthday_Date</h2><hr>";
    ...
    // Birthday -Wish  button
            echo "<div class='text-center download-btn'>
                    <a href='birthday/birth-email.php' class='btn btn-primary'><i class='fas fa-mouse-pointe'></i>Click-To Wishes[send]</a>
                </div>";
